...
// Upload a tree from a URL
function uploadTreeFromURL(url, resolve = function() { }){
    ...
    xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
            ...
            parseTree(xhttp.responseText, resolve);
...
function parseTree(nexus_str, resolve = function() { }){
