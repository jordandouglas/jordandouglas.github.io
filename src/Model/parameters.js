...
PARAMS_JS.PHYSICAL_PARAMETERS["GDagSlide"] = {distribution:"Fixed", fixedDistnVal: 11, uniformDistnLowerVal: 9, uniformDistnUpperVal: 15, name: "\u0394\u0394G\u2020t", latexName: "\u0394\u0394G_{t}^{\u2020}  (k_{B}T)", title: "Free energy barrier height of translocation", zeroTruncated: false, integer: false};
...
PARAMS_JS.PHYSICAL_PARAMETERS["barrierPos"] = {distribution:"Fixed", fixedDistnVal: 1.7, uniformDistnLowerVal: 0, uniformDistnUpperVal: 3.4, normalSdVal: 0.4, name: "Barrier height position  (\u212B)", latexName: "\u03B4_{1}",  title: "Position of translocation intermediate state", zeroTruncated: "exclusive", integer: false};
